...
// Get the user using the userId (_id)
exports.getUser = function (userId, callBack) {   //i registered one user with skyjillain, now can login using userID
    User.findById(userId, (err, data) => {    // copied from mongoosejs.com/docs, API, model section
...
// this was before he separated agency_model.js out, only mongoose_data.js
// const Agency = require('./mongoose_models')
// exports.getContactDate = (agencyId, callBack) => {
        //// if (!agencyId)                
//      Agency.find({}, callBank);
        //// else
        // getData("agents", [agencyId], callBank);
// }